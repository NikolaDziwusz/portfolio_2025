...
export function Contact() {
    ...
    return (
        <>
            <section
                className="flex-1 flex flex-col items-center justify-center px-2 py-8 lg:py-20 relative overflow-hidden">
                {/* Animated background elements */}
                <div className="absolute inset-0 overflow-hidden">
                    <div
                        className="absolute -top-40 -right-40 w-60 sm:w-80 h-60 sm:h-80 bg-orange-500/10 rounded-full blur-3xl animate-pulse"></div>
                    <div
                        className="absolute -bottom-40 -left-40 w-60 sm:w-80 h-60 sm:h-80 bg-teal-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
                </div>
